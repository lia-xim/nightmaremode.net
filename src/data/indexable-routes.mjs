...
export const pageRegistry = Object.freeze([
  ...
  { route: "/about/site-operations/", indexable: false, cluster: "governance", action: "keep-noindex", primaryJob: "Verify the same-owner Crawl Foundry operating relationship and the claims it does not support." },
  ...
  { route: "/de/ueber-uns/website-betrieb/", indexable: false, cluster: "governance", action: "keep-noindex", primaryJob: "Die gemeinsam betriebene Crawl-Foundry-Arbeitsbeziehung und ihre Beleggrenzen prüfen." },
