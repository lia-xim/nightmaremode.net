export const pageRegistry = Object.freeze([
  ...
  { route: "/field-notes/", indexable: true, cluster: "play-studies", action: "strengthen", primaryJob: "Find documented play-study methods and future observation-led field notes." },
